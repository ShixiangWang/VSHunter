...
[![CRAN status](https://www.r-pkg.org/badges/version/VSHunter)](https://cran.r-project.org/package=VSHunter) [![GitHub tag](https://img.shields.io/github/tag/ShixiangWang/VSHunter.svg?label=Github)](https://github.com/ShixiangWang/VSHunter) [![Build status](https://ci.appveyor.com/api/projects/status/2n62nnwl8u2dpmc5/branch/master?svg=true)](https://ci.appveyor.com/project/ShixiangWang/vshunter/branch/master)
