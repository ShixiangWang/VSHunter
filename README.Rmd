...
[![GitHub tag](https://img.shields.io/github/tag/ShixiangWang/VSHunter.svg?label=Github)](https://github.com/ShixiangWang/VSHunter) [![lifecycle](https://img.shields.io/badge/lifecycle-experimental-orange.svg)](https://www.tidyverse.org/lifecycle/#experimental) [![Travis build status](https://travis-ci.org/ShixiangWang/VSHunter.svg?branch=master)](https://travis-ci.org/ShixiangWang/VSHunter) [![Coverage status](https://codecov.io/gh/ShixiangWang/cnPattern/branch/master/graph/badge.svg)](https://codecov.io/github/ShixiangWang/cnPattern?branch=master)
